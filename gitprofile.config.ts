...
const CONFIG = {
  github: {
    username: 'Jeromel-Pushparaj', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['Jeromel-Pushparaj/E-Commerce-Front-End-Design', 'Jeromel-Pushparaj/pandora'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  seo: {
    title: 'Portfolio of Jeromel-Pushparaj',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'jeromel-pushparaj',
    twitter: '-',
    mastodon: '-',
    researchGate: '',
    facebook: '',
    ...
    medium: '-',
    dev: '-',
    stackoverflow: '22340263/jeromel-pushparaj', // example: '1/jeff-atwood'
    skype: '',
    telegram: '',
    website: 'https://jeromelpushparaj.netlify.app/',
    phone: '',
    email: 'jeromal03@gmail.com',
  },
  resume: {
    fileUrl:
